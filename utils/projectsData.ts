export const projectsData = [
  {
    ...
    codeBack: 'https://github.com/jtnovellis/sillevon-back',
  },
  {
    title: 'Latam Airlines Clone',
    link: 'https://latam-airlines.vercel.app',
    imageUrl: '/latamairlines-project.png',
    status: 'Completed',
    description:
      'Latam is an airline, ranked as the largest in Latin America for its large fleet and the number of people transported. We have decided to make a clone of their web application, where we will implement all the features they have to provide the service.',
